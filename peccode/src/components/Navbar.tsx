...
import { Code, Home, Settings, LayoutDashboard, ChevronDown, User, LogOut, Menu, X, Terminal, UserPlus } from 'lucide-react';
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user ? (
              ...
              <motion.div 
                ...
                transition={{ delay: 0.7 }}
              >
                <Link to="/login" className="btn-outline px-4 py-2 flex items-center">
                  <LogIn size={16} className="mr-1" />
                  <span>Sign in</span>
                </Link>
                <Link to="/signup" className="btn-primary px-4 py-2 flex items-center">
            ...
            <div className="px-4 py-3 space-y-3">
              ...
              {user ? (
                ...
                >
                  <Link
                    to="/login"
                    className="btn-outline w-full text-center flex justify-center items-center py-2"
                    onClick={closeMenu}
                  >
                  ...
                  <Link
                    to="/signup"
                    className="btn-primary w-full text-center flex justify-center items-center py-2"
                    onClick={closeMenu}
                  >
...
const LogIn = ({ size, className }: { size: number; className?: string }) => (
  <svg 
